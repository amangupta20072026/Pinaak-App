...
const ArrowLeftIcon: React.FC<IconProps> = ({ color, size }) => (
...
const ClockIcon: React.FC<IconProps> = ({ color, size }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <View style={styles.card}>
        ...
        >
          ...
          <View style={styles.cardNoteRow}>
            <ClockIcon color={noteColor} size={13} />
            <Text style={[styles.cardNote, { color: noteColor }]}>
              {note}
            </Text>
          </View>
        </Pressable>
        ...
        >
          <View style={styles.heroText}>
            ...
            <Text style={styles.heroSubtitle}>
              Reach out to our support team for any assistance. We&apos;ll
